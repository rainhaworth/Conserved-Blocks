...
# changed the parts that break, basically moving from gensim 3 -> gensim 4
...
class MultiKModel:
    ...
    def separate_out_model(self, k_len):
        ...
        with tempfile.NamedTemporaryFile(mode='w') as fptr:
            ...
            return SingleKModel(word2vec.KeyedVectors.load_word2vec_format(fptr.name, binary=False))
