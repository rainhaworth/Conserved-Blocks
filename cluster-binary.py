...
mfile = '/fs/nexus-scratch/rhaworth/models/skew-shuffled.model.h5'
...
for iter in range(iterations):
    ...
    for i in tqdm(range(0, len(unclustered), batch_size), 'searching full dataset'):
        ...
        for repnum, rep in enumerate(representatives):
            # get batch of representatives
            y = np.zeros((batch_size, max_len)) # all these sizes might be wrong lol i'm writing this so late
    ...
    # 5. update list of remaining points in dataset
